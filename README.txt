...
4. Retrieve student grades from Moodle using the Moodle API
5. Combine the report data and Moodle grades
6. Send the combined data to AI API such as Anthropic API or Open API to have them generate a personal study plan for each of the Students
7. Get the response from the AI API
8. Send the response to each student using their email addresses
